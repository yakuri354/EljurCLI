...
def eljur_login():
    ...
    #     eljur_auth_choice[0]["choices"].append(
    #         {
    #             "name": "{name} ({grade} класс)".format(
    #                 name=logged_users[i]["name"],
    #                 grade=logged_users[i]["grade"]
    #             ),
    ...
    #
    #     current_student = Student(auth_response['response']['result']['token'], login)
    #
    #     logged_users[current_student.login] = {
    #         "login": current_student.login,
    #         "token": current_student.token,
    ...
    # else:
    #     try:
    #         current_student = Student(login, logged_users[login]["token"])
    #     except LookupError:
    #         sign_in_promt = pq.prompt([
    #             {
    #                 "type": "input",
